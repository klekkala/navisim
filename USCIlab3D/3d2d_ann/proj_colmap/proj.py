...
def proj(points, mask_f, res, label_proj, color_label):



    masks = torch.load(join(join('/lab/tmpig10c/kiran/Grounded-Segment-Anything/outputs/res/', mask_f), 'masks.pt'))
...
if __name__ == '__main__':
    ...
    for mask_f in os.listdir('/lab/tmpig10c/kiran/Grounded-Segment-Anything/outputs/res/'):
        res = proj(points2d, mask_f, res, label_proj, color_label)
