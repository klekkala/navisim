...
def proj(pose, pcd, img_path, mask, proj_dict):
    ...
    if cam_num == 1:
        ...
        R = np.dot(R, np.array([[0,1,0], [0,0,1], [1,0,0]]))
        R = np.dot(R, LiDAR_R)
        # t = np.array([-0.0225125, 0.162101, -0.178768])
        t = np.array([0.162101, -0.178768, -0.0225125])
    elif cam_num == 2:
        ...
        t = np.array([0.162078, -0.178564, -0.0220061])
    elif cam_num == 3:
        ...
        t = np.array([0.168518, -0.421818, 0.153234])
    elif cam_num == 4:
        ...
        t = np.array([0.167401, -0.25064, -0.100335])
    elif cam_num == 5:
        ...
        t = np.array([0.160828, -0.144208, -0.0337689])
...
if __name__ == '__main__':
    pcd = o3d.io.read_point_cloud('./data/surfaceMap.pcd')
    print(pcd)
    ...
    proj_dict = proj([-76.234573, -4.528607, 167.753464, 0.012135, -0.925408, -0.018664], pcd, './data/cam1_1687658158576471586/raw_image.jpg', 'cam1_dense', proj_dict)
    ...
    for idx, (point, obj) in enumerate(proj_dict.items()):
        print(idx)
