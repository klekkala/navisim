...
from pointcloud.elevation_map.elevation_map_visualization import *
...
class BeoGym(gym.Env):
    def __init__(self, config, sequence_graph, target_location, start_location = np.zeros(3, dtype=int), render_mode=None):
        ...
        current_point_cloud = self.current_node.get_point_cloud()
        self.elevation_map = current_point_cloud.get_elevation_map()
